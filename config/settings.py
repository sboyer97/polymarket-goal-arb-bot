...
class TradingSettings(BaseSettings):
    ...
    exit_after_seconds: float = Field(default=60.0, env="EXIT_AFTER_SECONDS")  # time exit live (s) - 60s pour capturer le mouvement rapide
    ...
    min_minute_to_bet: float = Field(default=0, env="MIN_MINUTE_TO_BET")  # 0 = tous les buts, 75 = buts tardifs
    min_liquidity_usd: float = Field(default=50.0, env="MIN_LIQUIDITY_USD")  # Liquidité min pour entrer
